...
export const ACCOUNT: any = {
    ...
    MONEY_IN_TRANSACTIONS: '/v1/account/entity/mpesa/transactions/money-in',
    MONEY_OUT_TRANSACTIONS: '/v1/account/entity/mpesa/transactions/money-out',
    VALIDATE_WITHDRAWAL: '/v1/account/artist/:auid/money-out/withdraw/check',
