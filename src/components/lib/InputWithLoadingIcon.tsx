                    ...
                    <input type="text" name={name} id={name} placeholder={placeHolder} autoComplete="off"
                        className={classNames(
                            errorsName.length > 0 ?
                                ...
                                'text-stone-900 ring-slate-300 placeholder:text-stone-400 border border-stone-300  focus:ring-purple-600 focus:outline-purple-500 hover:border-stone-400',
