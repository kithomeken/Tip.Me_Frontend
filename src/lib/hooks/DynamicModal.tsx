                                        ...
                                        <div className="bg-slate-100 px-4 py-4 sm:px-6 sm:flex sm:flex-row-reverse">
                                            <div className="w-full space-y-px">
                                                <div className="flex flex-row-reverse items-center align-middle">
                                                    {
                                                        noAction ? (
                                                            <button type="button" className="w-24 justify-center disabled:cursor-not-allowed text-sm rounded-md border border-transparent shadow-sm px-3 py-1-5 bg-purple-600 text-white disabled:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-0 focus:ring-offset-2 focus:ring-purple-500" onClick={showOrHideModal}>
                                                                Done
                                                            </button>
                                                        ) : (
                                                            <>
                                                                <button type="submit" className="w-20 justify-center disabled:cursor-not-allowed text-sm rounded-md border border-transparent shadow-sm px-3 py-1-5 bg-purple-600 text-white disabled:bg-purple-600 hover:bg-purple-700 focus:outline-none" disabled={posting}>
                                                                    {
                                                                        posting ? (
