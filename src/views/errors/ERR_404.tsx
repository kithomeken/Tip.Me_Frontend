                                        ...
                                        <div className="col-sm-12 sm:max-w-sm md:max-w-md lg:max-w-lg text-center">
                                            <div className="col-sm-10 col-sm-offset-1 text-center">
                                                ...
                                                <p className="text-slate-600 mb-5 text-sm">
                                                    ...
                                                    Oh no! It seems this page has gone on vacation. Don't worry; we'll send out a search party.
                                                    In the meantime, try exploring other corners of our digital universe.
                                                </p>

                                                <div className="space-y-3">
                                                    <div className="flex items-center justify-between">
                                                        <div className="text-sm m-auto ">
                                                            <Link to="/home" className="font-medium text-center text-emerald-600 hover:text-emerald-700">
