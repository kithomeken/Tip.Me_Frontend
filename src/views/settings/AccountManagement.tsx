...
export const AccountManagement = () => {
    ...
    return (
        <React.Fragment>
            ...
            <div className={`w-full bg-gradient-to-r from-purple-200 to-emerald-100 form-group mb-3 h-30`}>
                        ...
                        <div className="md:w-52 lg:w-60 md:pr-4 pt-4 pb-4 md:border-r">
                            <div className="w-full">
                                <button type="button" onClick={() => setActivateTab('recent')} className={classNames(
                                    state.activeTab === 'recent' ? 'text-purple-700 bg-purple-100' : 'text-slate-700 hover:bg-slate-100',
                                ...
                                <button type="button" onClick={() => setActivateTab('security')} className={classNames(
                                    state.activeTab === 'security' ? 'text-purple-700 bg-purple-100' : 'text-slate-700 hover:bg-slate-100',
                                ...
                                <button type="button" onClick={() => setActivateTab('preferences')} className={classNames(
                                    state.activeTab === 'preferences' ? 'text-purple-700 bg-purple-100' : 'text-slate-700 hover:bg-slate-100',
